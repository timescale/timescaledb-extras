...
- [`auto_downsample`](/docs/auto_aggregate_selection.md): Helper function to downsample timeseries data from an automatically selected continuous aggregate table.
