...
-- The cause of these values is unknown as of now. We plan to fix them
-- and monitor to see if they appear again.
--
-- This script:
-- 1. Updates invalidation thresholds to the max watermark of their caggs, 
--    if it is wrong (near END_TIMESTAMP)
-- 2. Updates the lowest_modified_value of the cagg's invalidation log entries
--    to their corresponding cagg's watermark, if the value is wrong
--    (near END_TIMESTAMP)
